 ...
 * @author Fanny
 */
public class AsignarIngredientes extends javax.swing.JFrame {

    /**
     * Creates new form AsignarIngredientes
     */
    public static Conexion objeto = new Conexion();
    public static DefaultTableModel modelo, modelo2;

    public AsignarIngredientes() {
        initComponents();
        this.setSize(new Dimension(1000, 640));

        this.setLocationRelativeTo(null);
        this.setTitle("Asignar Ingredientes - SISTEMA DE VENTAS");
        ...
        //TITULOS
        txtproducto.setText(AgregarProducto.txtnombre.getText());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Digite la cantidad de unidades que se requieren del ingrediente:");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 160, 480, 30));
        ...
        getContentPane().add(txtproducto, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, 620, 40));
        ...
        if (treceta.getColumnModel().getColumnCount() > 0) {
            treceta.getColumnModel().getColumn(0).setMinWidth(30);
            treceta.getColumnModel().getColumn(0).setPreferredWidth(30);
            treceta.getColumnModel().getColumn(0).setMaxWidth(30);
            treceta.getColumnModel().getColumn(2).setMinWidth(80);
            treceta.getColumnModel().getColumn(2).setPreferredWidth(80);
            treceta.getColumnModel().getColumn(2).setMaxWidth(80);
        }
        ...
        if (tingre.getColumnModel().getColumnCount() > 0) {
            tingre.getColumnModel().getColumn(0).setMinWidth(30);
            tingre.getColumnModel().getColumn(0).setPreferredWidth(30);
            tingre.getColumnModel().getColumn(0).setMaxWidth(30);
            tingre.getColumnModel().getColumn(2).setMinWidth(80);
            tingre.getColumnModel().getColumn(2).setPreferredWidth(80);
            tingre.getColumnModel().getColumn(2).setMaxWidth(80);
            tingre.getColumnModel().getColumn(3).setMinWidth(80);
            tingre.getColumnModel().getColumn(3).setPreferredWidth(80);
            tingre.getColumnModel().getColumn(3).setMaxWidth(80);
            tingre.getColumnModel().getColumn(3).setHeaderValue("Unidad");
        }
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 460, 40));
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        int resul = JOptionPane.showConfirmDialog(this, "¿Desea registrar el producto con su receta?", "¿Confirmar?", a);
        if (resul == 0) {
            //agrega el producto EN TB_PRODUCTO
            ResultSet respuesta2 = objeto.consultarRegistros("Select nombre from tb_producto where nombre='" + AgregarProducto.txtnombre.getText() + "'");
            try {
                if (respuesta2.next()) {
                    JOptionPane.showMessageDialog(null, "El producto ya ha sido registrado anteriormente.");
                } else {
                    int cate = 0;
                    ResultSet respuesta = objeto.consultarRegistros("Select idcategoria from tb_categoria where descripcion='" + AgregarProducto.cbxcate.getSelectedItem().toString() + "'");
                    respuesta.next();
                    cate = (respuesta.getInt("idcategoria"));
                    objeto.agregarProducto(AgregarProducto.txtnombre.getText(),
                            Double.parseDouble(AgregarProducto.txtprecio.getText()),
                            AgregarProducto.txtdescripcion.getText(),
                            Integer.parseInt(AgregarProducto.txtiva.getText()),
                            cate);
            ...
            AgregarProducto.txtnombre.setText("");
            AgregarProducto.txtprecio.setText("");
            AgregarProducto.txtdescripcion.setText("");
            AgregarProducto.txtiva.setText("");
            AgregarProducto.cbxcate.setSelectedIndex(0);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarIngredientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AsignarIngredientes().setVisible(true);
            }
        });
    }
