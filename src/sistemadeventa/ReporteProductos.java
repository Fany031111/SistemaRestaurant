...
import static sistemadeventa.ReporteClientes.fechalbl;
import static sistemadeventa.ReporteClientes.horalbl;

/**
 *
 * @author Fanny
 */
public class ReporteProductos extends javax.swing.JFrame implements Runnable{
    ...
    private void initComponents() {
        ...
        if (tproducto.getColumnModel().getColumnCount() > 0) {
            tproducto.getColumnModel().getColumn(0).setMinWidth(70);
            tproducto.getColumnModel().getColumn(0).setPreferredWidth(70);
            tproducto.getColumnModel().getColumn(0).setMaxWidth(70);
            tproducto.getColumnModel().getColumn(1).setMinWidth(200);
            ...
            tproducto.getColumnModel().getColumn(4).setMinWidth(50);
            tproducto.getColumnModel().getColumn(4).setPreferredWidth(50);
            tproducto.getColumnModel().getColumn(4).setMaxWidth(50);
            tproducto.getColumnModel().getColumn(5).setMinWidth(120);
            tproducto.getColumnModel().getColumn(5).setPreferredWidth(120);
            tproducto.getColumnModel().getColumn(5).setMaxWidth(120);
        }

        getContentPane().add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 180, 850, 370));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 90, 850, 80));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 570, 150, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try {
                ...
                titulo2.setFont(f3);
                titulo2.add("Reporte de productos");
                ...
                float[] columnWidths = {0.5f, 2f, 1f, 3f, 0.5f, 1.5f};
                ...
                header = new PdfPCell(new Phrase("Nombre", fontTabla));
                header.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(header);

                header = new PdfPCell(new Phrase("Precio", fontTabla));
                header.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(header);

                header = new PdfPCell(new Phrase("Descripción", fontTabla));
                header.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(header);

                header = new PdfPCell(new Phrase("%IVA", fontTabla));
                header.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(header);

                header = new PdfPCell(new Phrase("Categoría", fontTabla));
                header.setBackgroundColor(BaseColor.LIGHT_GRAY);
                tabla.addCell(header);
