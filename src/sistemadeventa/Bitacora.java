 ...
 * @author Fanny
 */
public class Bitacora extends javax.swing.JFrame implements Runnable{
    ...
    public Bitacora() {
        ...
        this.setTitle("Bitácora - SISTEMA DE VENTAS");
    ...
    static void ConsultarDatos(String id, String nombre) throws SQLException {
        ...
        try {
            ...
            StringBuilder query = new StringBuilder("SELECT * FROM tb_bitacora WHERE 1=1");
            List<Object> params = new ArrayList<>();

            // Agregar filtros según los parámetros
            if (!id.equals("")) {
                query.append(" AND idbitacora LIKE ?");
                params.add(id + "%");
            }
            if (!nombre.equals("")) {
                query.append(" AND mensaje LIKE ?");
                params.add("%" + nombre + "%");
            }
    ...
    private void initComponents() {
        ...
        getContentPane().add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 180, 1150, 400));

        jPanel1.setBackground(new java.awt.Color(0, 153, 204));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Filtrar bitácora por:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 18), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 30, -1, 30));
        ...
        jPanel1.add(fnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 30, 840, 30));
        ...
        jPanel1.add(limpiarfiltro, new org.netbeans.lib.awtextra.AbsoluteConstraints(1080, 30, 40, 30));

        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 90, 1150, 80));
