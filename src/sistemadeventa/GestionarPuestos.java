 ...
 * @author Fanny
 */
public class GestionarPuestos extends javax.swing.JFrame implements Runnable {
    ...
    public GestionarPuestos() {
        ...
        this.setTitle("Gestionar Puestos - SISTEMA DE VENTAS");
    ...
    static void ConsultarDatos(String id, String puesto) throws SQLException {
        ...
        try {
            ...
            StringBuilder query = new StringBuilder("SELECT * FROM tb_tipousuario WHERE 1=1");
            List<Object> params = new ArrayList<>();

            // Agregar filtros según los parámetros
            if (!id.equals("")) {
                query.append(" AND idtipousuario LIKE ?");
                params.add(id + "%");
            }
            if (!puesto.equals("")) {
            ...
            modelo = (DefaultTableModel) tpuesto.getModel();
    ...
    private void initComponents() {
        ...
        tpuesto = new javax.swing.JTable();
        ...
        tpuesto.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        tpuesto.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        tpuesto.setRowHeight(30);
        tpuesto.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                tpuestoMouseClicked(evt);
            }
        });
        scroll.setViewportView(tpuesto);

        getContentPane().add(scroll, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 190, 850, 400));

        jLabel3.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("ID del puesto:");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 270, -1, 40));

        txtid.setEditable(false);
        txtid.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        getContentPane().add(txtid, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 270, 120, 40));

        jLabel12.setFont(new java.awt.Font("Segoe UI", 1, 18)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Puesto:");
        getContentPane().add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 320, -1, 40));
        getContentPane().add(txtpuesto, new org.netbeans.lib.awtextra.AbsoluteConstraints(900, 370, 250, 40));
        ...
        getContentPane().add(btnactualizar, new org.netbeans.lib.awtextra.AbsoluteConstraints(970, 430, 50, 50));
        ...
        getContentPane().add(btneliminar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1030, 430, 50, 50));
        ...
        getContentPane().add(btnagregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 430, 50, 50));

        btnlimipiar.setBackground(new java.awt.Color(204, 255, 255));
        btnlimipiar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/limpiar.png"))); // NOI18N
        btnlimipiar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnlimipiarActionPerformed(evt);
            }
        });
        getContentPane().add(btnlimipiar, new org.netbeans.lib.awtextra.AbsoluteConstraints(1090, 430, 50, 50));

        jPanel1.setBackground(new java.awt.Color(0, 153, 204));
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Filtrar puesto por:", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 1, 14), new java.awt.Color(255, 255, 255))); // NOI18N
        ...
        jPanel1.add(fid, new org.netbeans.lib.awtextra.AbsoluteConstraints(50, 30, 140, 30));
        ...
        jPanel1.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 30, -1, 30));
        ...
        jPanel1.add(fnombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(270, 30, 490, 30));
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 100, 850, 70));
    ...
    private void tpuestoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tpuestoMouseClicked
        // TODO add your handling code here:
        int fila = tpuesto.getSelectedRow();
        txtid.setText(tpuesto.getValueAt(fila, 0).toString());
        txtpuesto.setText(tpuesto.getValueAt(fila, 1).toString());

    }//GEN-LAST:event_tpuestoMouseClicked

    private void btnactualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnactualizarActionPerformed
        if ("".equals(txtpuesto.getText())) {
            JOptionPane.showMessageDialog(null, "Error: llene los espacios correspondientes.");
        } else {
            ResultSet respuesta2 = objeto.consultarRegistros("Select tipo from tb_tipousuario where tipo='" + txtpuesto.getText() + "'");
            try {
                if (respuesta2.next()) {
                    JOptionPane.showMessageDialog(null, "El puesto ya ha sido registrado anteriormente.");
                } else {
                    objeto.actualizarTipoUsuario(
    ...
    private void btneliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btneliminarActionPerformed
        ...
        if ("".equals(txtid.getText())) {
            ...
            try {
                ...
                ResultSet respuesta = objeto.consultarRegistros("SELECT idtipousuario FROM tb_tipousuario WHERE idtipousuario = " + idusuario);
                if (respuesta.next()) {
                    // Llamar al método eliminarUsuario
                    objeto.eliminarTipoUsuario(idusuario);
                    limpiarDatos();
                } else {
                    JOptionPane.showMessageDialog(null, "El puesto con ID " + idusuario + " no existe.");
                }
    ...
    private void btnagregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnagregarActionPerformed
        ...
        if (puesto.isEmpty()) {
            JOptionPane.showMessageDialog(null, "El campo puesto no puede estar vacío.");
            return;
        }
        try {
            // Verificar si el puesto ya existe en la base de datos
            if (objeto.puestoYaExiste(puesto)) {
                JOptionPane.showMessageDialog(null, "El puesto '" + puesto + "' ya existe en la base de datos.");
                limpiarDatos();
                return;
            }
            // Agregar el nuevo puesto
            objeto.agregarTipoUsuario(puesto);
            limpiarDatos();
            ...
            JOptionPane.showMessageDialog(null, "Error al agregar el puesto: " + ex.getMessage());
        }
    ...
    public static javax.swing.JTable tpuesto;
